describe EmulatorProjectsController do
  ...
  describe 'PUT #update' do
    context 'as owner' do
      it 'assigns the requested project to @emulator_project' do
        put :update, id: project, emulator_project: FactoryGirl.attributes_for(:emulator_project)
        assigns(:emulator_project).should == project
      end

      it "changes @emulator_project's attributes" do
        put :update, id: project, emulator_project: FactoryGirl.attributes_for(:emulator_project, name: 'diff name')
        project.reload
  ...
  describe 'POST #create' do
    context 'with valid attributes' do
      it 'creates a new emulator project' do
        expect {
          post :create, FactoryGirl.attributes_for(:emulator_project)
